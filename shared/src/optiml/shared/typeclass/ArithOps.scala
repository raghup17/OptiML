...
trait ArithOps extends Base with scala.math.Numeric.ExtraImplicits {
  ...
  implicit def canArithTup6[A:Arith:Manifest,B:Arith:Manifest,C:Arith:Manifest,D:Arith:Manifest,E:Arith:Manifest,F:Arith:Manifest]: Arith[Tup6[A,B,C,D,E,F]] = new Arith[Tup6[A,B,C,D,E,F]] {
  ...
  implicit def canArithDenseMatrix[T:Arith:Manifest]: Arith[DenseMatrix[T]] = new Arith[DenseMatrix[T]] {
    ...
    def empty(implicit __pos: SourceContext) = {
      DenseMatrix[T](unit(0),unit(0)).unsafeImmutable
    }
  ...
  implicit def canArithTup5[A:Arith:Manifest,B:Arith:Manifest,C:Arith:Manifest,D:Arith:Manifest,E:Arith:Manifest]: Arith[Tup5[A,B,C,D,E]] = new Arith[Tup5[A,B,C,D,E]] {
  ...
  implicit def canArithTup7[A:Arith:Manifest,B:Arith:Manifest,C:Arith:Manifest,D:Arith:Manifest,E:Arith:Manifest,F:Arith:Manifest,G:Arith:Manifest]: Arith[Tup7[A,B,C,D,E,F,G]] = new Arith[Tup7[A,B,C,D,E,F,G]] {
  ...
  implicit def canArithTup4[A:Arith:Manifest,B:Arith:Manifest,C:Arith:Manifest,D:Arith:Manifest]: Arith[Tup4[A,B,C,D]] = new Arith[Tup4[A,B,C,D]] {
  ...
  implicit def canArithDenseVector[T:Arith:Manifest]: Arith[DenseVector[T]] = new Arith[DenseVector[T]] {
    ...
    def empty(implicit __pos: SourceContext) = {
      DenseVector[T](unit(0),unit(true)).unsafeImmutable
    }
  ...
  implicit def canArithTup2[A:Arith:Manifest,B:Arith:Manifest]: Arith[Tup2[A,B]] = new Arith[Tup2[A,B]] {
  ...
  implicit def canArithTup8[A:Arith:Manifest,B:Arith:Manifest,C:Arith:Manifest,D:Arith:Manifest,E:Arith:Manifest,F:Arith:Manifest,G:Arith:Manifest,H:Arith:Manifest]: Arith[Tup8[A,B,C,D,E,F,G,H]] = new Arith[Tup8[A,B,C,D,E,F,G,H]] {
  ...
  implicit def canArithTup3[A:Arith:Manifest,B:Arith:Manifest,C:Arith:Manifest]: Arith[Tup3[A,B,C]] = new Arith[Tup3[A,B,C]] {
  ...
  implicit def canArithTup9[A:Arith:Manifest,B:Arith:Manifest,C:Arith:Manifest,D:Arith:Manifest,E:Arith:Manifest,F:Arith:Manifest,G:Arith:Manifest,H:Arith:Manifest,I:Arith:Manifest]: Arith[Tup9[A,B,C,D,E,F,G,H,I]] = new Arith[Tup9[A,B,C,D,E,F,G,H,I]] {
   ...
   */
  implicit class Arith2ArithOps[T:Manifest:Arith](self: Rep[T]) {
  ...
  def arith_zero[T:Manifest:Arith](__arg0: Rep[T])(implicit __pos: SourceContext): Rep[T] = implicitly[Arith[T]].zero(__arg0)
  def arith_empty[T:Manifest:Arith]()(implicit __pos: SourceContext): Rep[T] = implicitly[Arith[T]].empty
  def arith_pl[T:Manifest:Arith](__arg0: Rep[T],__arg1: Rep[T])(implicit __pos: SourceContext): Rep[T] = implicitly[Arith[T]].+(__arg0,__arg1)
  def arith_sub[T:Manifest:Arith](__arg0: Rep[T],__arg1: Rep[T])(implicit __pos: SourceContext): Rep[T] = implicitly[Arith[T]].-(__arg0,__arg1)
  def arith_mul[T:Manifest:Arith](__arg0: Rep[T],__arg1: Rep[T])(implicit __pos: SourceContext): Rep[T] = implicitly[Arith[T]].*(__arg0,__arg1)
  def arith_div[T:Manifest:Arith](__arg0: Rep[T],__arg1: Rep[T])(implicit __pos: SourceContext): Rep[T] = implicitly[Arith[T]]./(__arg0,__arg1)
  def arith_abs[T:Manifest:Arith](__arg0: Rep[T])(implicit __pos: SourceContext): Rep[T] = implicitly[Arith[T]].abs(__arg0)
  def arith_exp[T:Manifest:Arith](__arg0: Rep[T])(implicit __pos: SourceContext): Rep[T] = implicitly[Arith[T]].exp(__arg0)
  def arith_log[T:Manifest:Arith](__arg0: Rep[T])(implicit __pos: SourceContext): Rep[T] = implicitly[Arith[T]].log(__arg0)
}
