...
abstract class MatcherFactory2[-SC, TC1[_], TC2[_]] { thisMatcherFactory =>
  ...
  final class AndBeWord {
     ...
     * </pre>
     */
    def a(symbol: Symbol): MatcherFactory2[SC with AnyRef, TC1, TC2] = and(MatcherWords.be.a(symbol))
     ...
     * </pre>
     */
    def an(symbol: Symbol): MatcherFactory2[SC with AnyRef, TC1, TC2] = and(MatcherWords.be.an(symbol))
  ...
  final class AndNotWord {
     ...
     * </pre>
     */
    def be(symbol: Symbol): MatcherFactory2[SC with AnyRef, TC1, TC2] = thisMatcherFactory.and(MatcherWords.not.be(symbol))
     ...
     * </pre>
     */
    def be(resultOfAWordApplication: ResultOfAWordToSymbolApplication): MatcherFactory2[SC with AnyRef, TC1, TC2] = thisMatcherFactory.and(MatcherWords.not.be(resultOfAWordApplication))
     ...
     * </pre>
     */
    def be(resultOfAnWordApplication: ResultOfAnWordToSymbolApplication): MatcherFactory2[SC with AnyRef, TC1, TC2] = thisMatcherFactory.and(MatcherWords.not.be(resultOfAnWordApplication))
     ...
     * </pre>
     */
    def be(aType: ResultOfATypeInvocation[_]): MatcherFactory2[SC with AnyRef, TC1, TC2] = thisMatcherFactory.and(MatcherWords.not.be(aType))
     ...
     * </pre>
     */
    def be(anType: ResultOfAnTypeInvocation[_]): MatcherFactory2[SC with AnyRef, TC1, TC2] = thisMatcherFactory.and(MatcherWords.not.be(anType))
  ...
  final class OrBeWord {
     ...
     * </pre>
     */
    def a(symbol: Symbol): MatcherFactory2[SC with AnyRef, TC1, TC2] = or(MatcherWords.be.a(symbol))
     ...
     * </pre>
     */
    def an(symbol: Symbol): MatcherFactory2[SC with AnyRef, TC1, TC2] = or(MatcherWords.be.an(symbol))
  ...
  final class OrNotWord {
     ...
     * </pre>
     */
    def be(symbol: Symbol): MatcherFactory2[SC with AnyRef, TC1, TC2] = thisMatcherFactory.or(MatcherWords.not.be(symbol))
     ...
     * </pre>
     */
    def be(resultOfAWordApplication: ResultOfAWordToSymbolApplication): MatcherFactory2[SC with AnyRef, TC1, TC2] = thisMatcherFactory.or(MatcherWords.not.be(resultOfAWordApplication))
     ...
     * </pre>
     */
    def be(resultOfAnWordApplication: ResultOfAnWordToSymbolApplication): MatcherFactory2[SC with AnyRef, TC1, TC2] = thisMatcherFactory.or(MatcherWords.not.be(resultOfAnWordApplication))
     ...
     * </pre>
     */
    def be(aType: ResultOfATypeInvocation[_]): MatcherFactory2[SC with AnyRef, TC1, TC2] = thisMatcherFactory.or(MatcherWords.not.be(aType))
     ...
     * </pre>
     */
    def be(anType: ResultOfAnTypeInvocation[_]): MatcherFactory2[SC with AnyRef, TC1, TC2] = thisMatcherFactory.or(MatcherWords.not.be(anType))
