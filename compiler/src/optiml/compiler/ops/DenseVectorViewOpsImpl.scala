...
trait DenseVectorViewOpsImpl {
  ...
  def densevectorview_zip_impl3_zip[T:Manifest,B:Manifest,R:Manifest](self: Rep[DenseVectorView[T]],__arg1: Rep[DenseVector[B]],__arg2: (Rep[T],Rep[B]) => Rep[R])(implicit __pos: SourceContext): (Rep[T],Rep[B]) => Rep[R] = {
    (a,b) => __arg2(a,b)
  }

  def densevectorview_zip_impl4_zip[T:Manifest,B:Manifest,R:Manifest](self: Rep[DenseVectorView[T]],__arg1: Rep[DenseVectorView[B]],__arg2: (Rep[T],Rep[B]) => Rep[R])(implicit __pos: SourceContext): (Rep[T],Rep[B]) => Rep[R] = {
    (a,b) => __arg2(a,b)
  }
  ...
  def densevectorview_prod_impl2_reduce[T:Manifest](self: Rep[DenseVectorView[T]])(implicit __pos: SourceContext,__imp0: Arith[T]): (Rep[T],Rep[T]) => Rep[T] = {
    (a,b) => a*b
  }

  def densevectorview_prod_impl2_zero[T:Manifest](self: Rep[DenseVectorView[T]])(implicit __pos: SourceContext,__imp0: Arith[T]): Rep[T] = {
  ...
  def densevectorview_min_impl4_reduce[T:Manifest](self: Rep[DenseVectorView[T]])(implicit __pos: SourceContext,__imp0: Ordering[T]): (Rep[T],Rep[T]) => Rep[T] = {
    (a,b) => if (a < b) a else b
  }

  def densevectorview_min_impl4_zero[T:Manifest](self: Rep[DenseVectorView[T]])(implicit __pos: SourceContext,__imp0: Ordering[T]): Rep[T] = {
    self(0)
  }

  def densevectorview_max_impl4_reduce[T:Manifest](self: Rep[DenseVectorView[T]])(implicit __pos: SourceContext,__imp0: Ordering[T]): (Rep[T],Rep[T]) => Rep[T] = {
    (a,b) => if (a > b) a else b
  }

  def densevectorview_max_impl4_zero[T:Manifest](self: Rep[DenseVectorView[T]])(implicit __pos: SourceContext,__imp0: Ordering[T]): Rep[T] = {
    self(0)
  }
  ...
  def densevectorview_map_impl2_map[T:Manifest,R:Manifest](self: Rep[DenseVectorView[T]],__arg1: (Rep[T]) => Rep[R])(implicit __pos: SourceContext): (Rep[T]) => Rep[R] = {
    e => __arg1(e)
  }

  def densevectorview_reduce_impl2_reduce[T:Manifest](self: Rep[DenseVectorView[T]],__arg1: (Rep[T],Rep[T]) => Rep[T])(implicit __pos: SourceContext,__imp0: Arith[T]): (Rep[T],Rep[T]) => Rep[T] = {
    (a,b) => __arg1(a,b)
  }

  def densevectorview_reduce_impl2_zero[T:Manifest](self: Rep[DenseVectorView[T]],__arg1: (Rep[T],Rep[T]) => Rep[T])(implicit __pos: SourceContext,__imp0: Arith[T]): Rep[T] = {
    implicitly[Arith[T]].zero(self(unit(0)))
  }

  def densevectorview_foreach_impl3_func[T:Manifest](self: Rep[DenseVectorView[T]],__arg1: (Rep[T]) => Rep[Unit])(implicit __pos: SourceContext): (Rep[T]) => Rep[Unit] = {
    e => __arg1(e)
  }
  ...
  def densevectorview_densevector_filter_map_impl_cond[T:Manifest,R:Manifest](self: Rep[DenseVectorView[T]],__arg1: (Rep[T]) => Rep[Boolean],__arg2: (Rep[T]) => Rep[R])(implicit __pos: SourceContext): (Rep[T]) => Rep[Boolean] = {
    e => __arg1(e)
  }

  def densevectorview_densevector_filter_map_impl_map[T:Manifest,R:Manifest](self: Rep[DenseVectorView[T]],__arg1: (Rep[T]) => Rep[Boolean],__arg2: (Rep[T]) => Rep[R])(implicit __pos: SourceContext): (Rep[T]) => Rep[R] = {
    e => __arg2(e)
  }
