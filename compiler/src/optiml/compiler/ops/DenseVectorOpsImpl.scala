...
trait DenseVectorOpsImpl {
  ...
  def densevector_groupby_helper_impl_key[T:Manifest,K:Manifest,V:Manifest](__arg0: Rep[DenseVector[T]],__arg1: (Rep[T]) => Rep[K],__arg2: (Rep[T]) => Rep[V])(implicit __pos: SourceContext): (Rep[T]) => Rep[K] = {
    e => __arg1(e)
  }

  def densevector_groupby_helper_impl_map[T:Manifest,K:Manifest,V:Manifest](__arg0: Rep[DenseVector[T]],__arg1: (Rep[T]) => Rep[K],__arg2: (Rep[T]) => Rep[V])(implicit __pos: SourceContext): (Rep[T]) => Rep[V] = {
    e => __arg2(e)
  }
  ...
  def densevector_clone_impl6_map[T:Manifest](self: Rep[DenseVector[T]])(implicit __pos: SourceContext): (Rep[T]) => Rep[T] = {
    e => e
  }
  ...
  def densevector_clngt_impl2_zip[T:Manifest](self: Rep[DenseVector[T]],__arg1: Rep[DenseVector[T]])(implicit __pos: SourceContext,__imp0: Ordering[T]): (Rep[T],Rep[T]) => Rep[Boolean] = {
    (a,b) => a > b
  }

  def densevector_clnlt_impl2_zip[T:Manifest](self: Rep[DenseVector[T]],__arg1: Rep[DenseVector[T]])(implicit __pos: SourceContext,__imp0: Ordering[T]): (Rep[T],Rep[T]) => Rep[Boolean] = {
    (a,b) => a < b
  }
  ...
  def densevector_groupbyreduce_impl_key[T:Manifest,K:Manifest,V:Manifest](self: Rep[DenseVector[T]],__arg1: (Rep[T]) => Rep[K],__arg2: (Rep[T]) => Rep[V],__arg3: (Rep[V],Rep[V]) => Rep[V])(implicit __pos: SourceContext,__imp0: Arith[V]): (Rep[T]) => Rep[K] = {
    e => __arg1(e)
  }

  def densevector_groupbyreduce_impl_map[T:Manifest,K:Manifest,V:Manifest](self: Rep[DenseVector[T]],__arg1: (Rep[T]) => Rep[K],__arg2: (Rep[T]) => Rep[V],__arg3: (Rep[V],Rep[V]) => Rep[V])(implicit __pos: SourceContext,__imp0: Arith[V]): (Rep[T]) => Rep[V] = {
    e => __arg2(e)
  }

  def densevector_groupbyreduce_impl_zero[T:Manifest,K:Manifest,V:Manifest](self: Rep[DenseVector[T]],__arg1: (Rep[T]) => Rep[K],__arg2: (Rep[T]) => Rep[V],__arg3: (Rep[V],Rep[V]) => Rep[V])(implicit __pos: SourceContext,__imp0: Arith[V]): Rep[V] = {
    implicitly[Arith[V]].empty
  }

  def densevector_groupbyreduce_impl_reduce[T:Manifest,K:Manifest,V:Manifest](self: Rep[DenseVector[T]],__arg1: (Rep[T]) => Rep[K],__arg2: (Rep[T]) => Rep[V],__arg3: (Rep[V],Rep[V]) => Rep[V])(implicit __pos: SourceContext,__imp0: Arith[V]): (Rep[V],Rep[V]) => Rep[V] = {
    (a,b) => __arg3(a,b)
  }
  ...
  def densevector_filter_impl3_cond[T:Manifest](self: Rep[DenseVector[T]],__arg1: (Rep[T]) => Rep[Boolean])(implicit __pos: SourceContext): (Rep[T]) => Rep[Boolean] = {
    e => __arg1(e)
  }

  def densevector_filter_impl3_map[T:Manifest](self: Rep[DenseVector[T]],__arg1: (Rep[T]) => Rep[Boolean])(implicit __pos: SourceContext): (Rep[T]) => Rep[T] = {
    e => e
  }
  ...
  def densevector_zip_impl6_zip[T:Manifest,B:Manifest,R:Manifest](self: Rep[DenseVector[T]],__arg1: Rep[DenseVector[B]],__arg2: (Rep[T],Rep[B]) => Rep[R])(implicit __pos: SourceContext): (Rep[T],Rep[B]) => Rep[R] = {
    (a,b) => __arg2(a,b)
  }

  def densevector_zip_impl7_zip[T:Manifest,B:Manifest,R:Manifest](self: Rep[DenseVector[T]],__arg1: Rep[DenseVectorView[B]],__arg2: (Rep[T],Rep[B]) => Rep[R])(implicit __pos: SourceContext): (Rep[T],Rep[B]) => Rep[R] = {
    (a,b) => __arg2(a,b)
  }
  ...
  def densevector_prod_impl4_reduce[T:Manifest](self: Rep[DenseVector[T]])(implicit __pos: SourceContext,__imp0: Arith[T]): (Rep[T],Rep[T]) => Rep[T] = {
    (a,b) => a*b
  }

  def densevector_prod_impl4_zero[T:Manifest](self: Rep[DenseVector[T]])(implicit __pos: SourceContext,__imp0: Arith[T]): Rep[T] = {
  ...
  def densevector_min_impl6_reduce[T:Manifest](self: Rep[DenseVector[T]])(implicit __pos: SourceContext,__imp0: Ordering[T]): (Rep[T],Rep[T]) => Rep[T] = {
    (a,b) => if (a < b) a else b
  }

  def densevector_min_impl6_zero[T:Manifest](self: Rep[DenseVector[T]])(implicit __pos: SourceContext,__imp0: Ordering[T]): Rep[T] = {
    self(0)
  }

  def densevector_max_impl6_reduce[T:Manifest](self: Rep[DenseVector[T]])(implicit __pos: SourceContext,__imp0: Ordering[T]): (Rep[T],Rep[T]) => Rep[T] = {
    (a,b) => if (a > b) a else b
  }

  def densevector_max_impl6_zero[T:Manifest](self: Rep[DenseVector[T]])(implicit __pos: SourceContext,__imp0: Ordering[T]): Rep[T] = {
    self(0)
  }
  ...
  def densevector_map_impl4_map[T:Manifest,R:Manifest](self: Rep[DenseVector[T]],__arg1: (Rep[T]) => Rep[R])(implicit __pos: SourceContext): (Rep[T]) => Rep[R] = {
    e => __arg1(e)
  }

  def densevector_reduce_impl3_reduce[T:Manifest](self: Rep[DenseVector[T]],__arg1: (Rep[T],Rep[T]) => Rep[T])(implicit __pos: SourceContext,__imp0: Arith[T]): (Rep[T],Rep[T]) => Rep[T] = {
    (a,b) => __arg1(a,b)
  }

  def densevector_reduce_impl3_zero[T:Manifest](self: Rep[DenseVector[T]],__arg1: (Rep[T],Rep[T]) => Rep[T])(implicit __pos: SourceContext,__imp0: Arith[T]): Rep[T] = {
    implicitly[Arith[T]].zero(self(unit(0)))
  }

  def densevector_foreach_impl5_func[T:Manifest](self: Rep[DenseVector[T]],__arg1: (Rep[T]) => Rep[Unit])(implicit __pos: SourceContext): (Rep[T]) => Rep[Unit] = {
    e => __arg1(e)
  }
  ...
  def densevector_densevector_filter_map_impl_cond[T:Manifest,R:Manifest](self: Rep[DenseVector[T]],__arg1: (Rep[T]) => Rep[Boolean],__arg2: (Rep[T]) => Rep[R])(implicit __pos: SourceContext): (Rep[T]) => Rep[Boolean] = {
    e => __arg1(e)
  }

  def densevector_densevector_filter_map_impl_map[T:Manifest,R:Manifest](self: Rep[DenseVector[T]],__arg1: (Rep[T]) => Rep[Boolean],__arg2: (Rep[T]) => Rep[R])(implicit __pos: SourceContext): (Rep[T]) => Rep[R] = {
    e => __arg2(e)
  }
