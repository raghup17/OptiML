...
trait IndexVectorOpsImpl {
  ...
  def indexvector_zip_impl1_zip[B:Manifest,R:Manifest](self: Rep[IndexVector],__arg1: Rep[DenseVector[B]],__arg2: (Rep[Int],Rep[B]) => Rep[R])(implicit __pos: SourceContext): (Rep[Int],Rep[B]) => Rep[R] = {
    (a,b) => __arg2(a,b)
  }

  def indexvector_zip_impl2_zip[B:Manifest,R:Manifest](self: Rep[IndexVector],__arg1: Rep[DenseVectorView[B]],__arg2: (Rep[Int],Rep[B]) => Rep[R])(implicit __pos: SourceContext): (Rep[Int],Rep[B]) => Rep[R] = {
    (a,b) => __arg2(a,b)
  }
  ...
  def indexvector_prod_impl1_reduce(self: Rep[IndexVector])(implicit __pos: SourceContext): (Rep[Int],Rep[Int]) => Rep[Int] = {
    (a,b) => a*b
  }

  def indexvector_prod_impl1_zero(self: Rep[IndexVector])(implicit __pos: SourceContext): Rep[Int] = {
    unit(1.asInstanceOf[Int])
  }
  ...
  def indexvector_min_impl2_reduce(self: Rep[IndexVector])(implicit __pos: SourceContext): (Rep[Int],Rep[Int]) => Rep[Int] = {
    (a,b) => if (a < b) a else b
  }

  def indexvector_min_impl2_zero(self: Rep[IndexVector])(implicit __pos: SourceContext): Rep[Int] = {
    self(0)
  }

  def indexvector_max_impl2_reduce(self: Rep[IndexVector])(implicit __pos: SourceContext): (Rep[Int],Rep[Int]) => Rep[Int] = {
    (a,b) => if (a > b) a else b
  }

  def indexvector_max_impl2_zero(self: Rep[IndexVector])(implicit __pos: SourceContext): Rep[Int] = {
    self(0)
  }
  ...
  def indexvector_map_impl1_map[R:Manifest](self: Rep[IndexVector],__arg1: (Rep[Int]) => Rep[R])(implicit __pos: SourceContext): (Rep[Int]) => Rep[R] = {
    e => __arg1(e)
  }

  def indexvector_reduce_impl1_reduce(self: Rep[IndexVector],__arg1: (Rep[Int],Rep[Int]) => Rep[Int])(implicit __pos: SourceContext): (Rep[Int],Rep[Int]) => Rep[Int] = {
    (a,b) => __arg1(a,b)
  }

  def indexvector_reduce_impl1_zero(self: Rep[IndexVector],__arg1: (Rep[Int],Rep[Int]) => Rep[Int])(implicit __pos: SourceContext): Rep[Int] = {
    zeroT
  }

  def indexvector_foreach_impl1_func(self: Rep[IndexVector],__arg1: (Rep[Int]) => Rep[Unit])(implicit __pos: SourceContext): (Rep[Int]) => Rep[Unit] = {
    e => __arg1(e)
  }
  ...
  def indexvector_densevector_filter_map_impl_cond[R:Manifest](self: Rep[IndexVector],__arg1: (Rep[Int]) => Rep[Boolean],__arg2: (Rep[Int]) => Rep[R])(implicit __pos: SourceContext): (Rep[Int]) => Rep[Boolean] = {
    e => __arg1(e)
  }

  def indexvector_densevector_filter_map_impl_map[R:Manifest](self: Rep[IndexVector],__arg1: (Rep[Int]) => Rep[Boolean],__arg2: (Rep[Int]) => Rep[R])(implicit __pos: SourceContext): (Rep[Int]) => Rep[R] = {
    e => __arg2(e)
  }
